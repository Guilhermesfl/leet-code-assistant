# LeetCode Problem List - 150 Problems

This list is strategically sequenced for progressive learning with spaced repetition. Problems are organized to revisit key concepts at intervals, starting with fundamentals and gradually increasing complexity.
...
- **Two Pointers & Sliding Window**: 18 problems
- **Stack & Queue**: 12 problems
- **Binary Search**: 8 problems
- **Linked Lists**: 15 problems
- **Trees & BST**: 25 problems
- **Graphs & BFS/DFS**: 18 problems
- **Dynamic Programming**: 18 problems
- **Backtracking**: 6 problems
- **Heaps & Priority Queue**: 5 problems
- **Tries**: 3 problems
- **Design Problems**: 7 problems

**Difficulty Breakdown**: ~40% Easy | ~50% Medium | ~10% Hard
